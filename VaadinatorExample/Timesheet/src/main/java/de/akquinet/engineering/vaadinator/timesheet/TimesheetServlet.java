...
@WebServlet(initParams = { @WebInitParam(name = "UI", value = "de.akquinet.engineering.vaadinator.timesheet.TimesheetUI"),
		@WebInitParam(name = "productionMode", value = "false"), @WebInitParam(name = "disable-xsrf-protection", value = "true"), }, urlPatterns = "/*")
public class TimesheetServlet extends TouchKitServlet {
