...
public class ContractApplicationChangePresenterImplEx extends ContractApplicationChangePresenterImpl {
	...
	public ContractApplicationChangePresenterImplEx(Map<String, Object> context, ContractApplicationChangeView view, Presenter returnPresenter,
	...
	@Override
	public void onSave() {
		throw new UnsupportedOperationException("Abgeschickte Anträge können nicht mehr bearbeitet werden!");
	}
